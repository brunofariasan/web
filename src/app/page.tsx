...
export default function Home() {
  ...
  <main className="grid grid-cols-2 min-h-screen">
    ...
    <div className="relative flex flex-col items-start justify-between px-28 py-16  overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
      ...
      {/* Sign In */}
      <a 
        href="#" className="flex items-center gap-3 text-left transition-colors hover:text-gray-50"
      >
      ...
      <div className='space-y-5'>
        ...
        <div className='max-w-[420px] space-y-1'>
          <h1 className='text-5xl font-bold leading-tight text-gray-50 font-sans'>Sua cápsula do tempo</h1>
      ...
      <div className='text-sm leading-relaxed text-gray-200'>
        ...
        target='_blank'
        rel='noreferrer'
        className='underline hover:text-gray-100' href='#'
        >
          Rocketseat
        </a>
      </div>
